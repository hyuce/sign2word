# NetworkBuilder will be used used to build the layers of CNN
...
#We need some activation layer to add nonlinearity in our network otherwise the network won’t be able to learn complex functions
...
# Let’s create a method for attaching a pooling layer to our network
...
# we have to convert that 3d input to flat 1D input
